...
def batch_norm(input_, epsilon=1e-5, momentum = 0.9, name=None, is_training=True):
    with tf.variable_scope(name):
        return tf.contrib.layers.batch_norm(input_, decay=momentum, updates_collections=None, epsilon=epsilon, scale=True, scope='bn', is_training=is_training)
